...
locals {
  ...
  ecs_service_name  = "${var.run_string}_service"

  ecs_task_name = "${var.run_string}_task"

  ecs_clus_name = "${var.run_string}_cluster"

  ecs_task_exec_role = "${var.run_string}_task_definition"

  ecs_load_bal = "${var.run_string}-LB2"

  ecs_load_bal_sg = "${var.run_string}_sg"

  ecs_target_group = "${var.run_string}-tg"

  ecs_clus_service_sg = "sg-875cb68f"
